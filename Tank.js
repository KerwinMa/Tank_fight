function Tank(posX, posZ) { 
	...
	this.getCorners = function() {
		var theta1 = Math.atan((-800 - this.x) / (-800 - this.z)); //var theta2 = Math.PI/2 - theta1; 
		var theta2 = Math.atan((-800 - this.x) / (800 - this.z));
		var theta3 = Math.atan((800 - this.x) / (800 - this.z));
		var theta4 = Math.atan((800 - this.x) / (-800 - this.z));
